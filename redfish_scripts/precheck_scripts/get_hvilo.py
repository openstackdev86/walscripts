...
class Hardware(object):
    ...
    def create_process(self):
        ...
        json.dump(d, file('/app/monitor/ilo_scripts/phase1/output_json/'+cloud_json, 'w'))
        failed_data['hosts'] = {"cloud_name":self.cloud_name,"data":failed_host}
        json.dump(failed_data, file('/app/monitor/ilo_scripts/phase1/failed_host/'+'failed_'+cloud_json, 'w'))
        json.dump(timeout_host, file('/app/monitor/ilo_scripts/phase1/failed_host/'+'timeout_'+cloud_json, 'w'))
        pid= os.getpid()
